...
"""
-> É uma lista de listas de números interios
...
Exercicio
-> Crie uma função que encontra o primeiro número duplicado considerando o segundo numero como duplicação.
    Requisitos:
        A ordem do número duplicado é considerada a partir da segunda ocorrência (o numero duplicado em si).
